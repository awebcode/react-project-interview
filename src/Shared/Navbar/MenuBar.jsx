...
const MenuBar = () => {
  ...
  const totalCartItems = getTotalItems()>0?getTotalItems():null;
            ...
            <ul className="overflow-hidden transition-all duration-500 ease-in-out font_sans">
              ...
              >
                ...
                >
                  ...
                  <span className="text-text_md font_sans font-medium ">Course</span>
                </Link>
              </li>
              <li
                className={` px-pt_8px my-mt_4px hover:cursor-pointer hover:rounded-rounded_primary hover: duration-200  ${
              ...
              >
                <Link to="/cart" className="flex items-center gap-gap_6px py-pt_primary">
                  ...
                  <span className="text-text_md font_sans font-medium ">
                    Cart <span className="text-emerald-500 ml-2">{totalCartItems ? `(${totalCartItems})` : null}</span>
                  </span>
                </Link>
              </li>
              <li
              ...
              >
                ...
                >
                  ...
                  <span className="text-text_md font_sans font-medium ">Checkout</span>
                </Link>
              </li>
              ...
              >
                ...
                >
                  ...
                  <span className="text-text_md font_sans font-medium ">Search</span>
                </Link>
              </li>
